...
public class EmployeeServiceImpl implements IEmployeeServices {
    ...
    @Autowired
    public EmployeeServiceImpl(IEmployeeRepository repository, ModelMapper modelMapper) {
    ...
    public ResponseEntity<EmployeeDto> getEmployeeById(@PathVariable(name="id") Long id) {
        EmployeeEntity employeeEntity=repository.findById(id)
                .orElseThrow( ()->new ResourceNotFoundException("Employee "+id+ "id bulunmadı"));
    ...
    public ResponseEntity<EmployeeDto> updateEmployee(@PathVariable(name="id") Long id,@RequestBody EmployeeDto employeeDto) {
        ...
        //setEntity
        employeeFind.setName(employeeEntity.getName());
        employeeFind.setEmail(employeeEntity.getEmail());
